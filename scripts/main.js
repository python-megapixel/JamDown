function showMenu() {
			document.getElementById("side-menu").style = "min-height: 50%;width:50%position: fixed;z-index: 1;top: 0;left: 0;background-color:#2196F3;overflow-x: hidden;padding-top: 20px;";
